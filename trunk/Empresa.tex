...
\begin{tabular}{|c|c|c|}
	\hline
	\cellcolor[gray]{0.8}\textbf{Fecha:} 04/04/2011 &  \cellcolor[gray]{0.8}\textbf{Comienzo:} 14:00  &  \cellcolor[gray]{0.8}\textbf{Fin:} 15:30 \\ \hline	
...
\begin{center}
\begin{tabular}{|c|c|c|}
	\hline \cellcolor[gray]{0.8}\textbf{Tarea} & \cellcolor[gray]{0.8}\textbf{Encargado} & \cellcolor[gray]{0.8}\textbf{Fecha de entrega} \\ 
...
en alguna parte de Latinoam\'erica (excepto Brasil y México) tiene que ponerse en contacto con Imagen y Comunicación S.A. 
...
\begin{tabular}{|c|c|c|}
	\hline
	\cellcolor[gray]{0.8}\textbf{Fecha:} 22/04/2011 &  \cellcolor[gray]{0.8}\textbf{Comienzo:} 15:00  &  \cellcolor[gray]{0.8}\textbf{Fin:} 16:00 \\ \hline	

	\multicolumn{3}{|c|}{\textbf{Lugar:} ``Imagen y Comunicaci\'on S.A.''} \\
	\hline \multicolumn{3}{|p{12.5cm}|}{\textbf{Presentes:} Por parte de la empresa: Enrique Paz (Director General)} \\
	\multicolumn{3}{|p{12.5cm}|}{Por parte de UBA: Aberastury, Lucía; Barbieri, Alejandro; Villanueva, Amalia; Camacho, Tania Gabriela; Garbarini, Lucía} \\
...
\begin{enumerate}
	...
	\item Profundización en el tema de organizaci\'on general de la empresa y las funciones de cada gerente.

    \item Relación con el cliente (Nike), y relaciones formales e informales dentro de la empresa.
\end{enumerate}


\textbf{Conclusiones:} Se conoció la historia de la empresa contada por su fundador. Se comprendió que las relaciones informales en la empresa prevalecen sobre las formales.\\
