...
\section{Im\'agen y Comunicaci\'on}
...
La empresa elegida es Im\'agen y Comunicaci\'on ya que tiene el puntaje m\'as alto y se han mostrado insteresados en ayudarnos
...
\begin{center}
\includegraphics[scale=0.70]{./herculesDiag.png}
 \end{center}
...
********** FALTA EL ESQUEMA DEL ENUNCIADO

\subsection{Organigrama Derivado del Enunciado}
\begin{center} \includegraphics[scale=0.58]{./dollyDiag.png} \end{center}

\subsection{An\'alisis FODA}
\begin{itemize}
 \item FORTALEZAS 
    \begin{itemize}
    \item Trabajar con materia prima de calidad.
    \item Ser una fabrica de tejido de punto integrada verticalmente hasta llegar al consumidor.
    \end{itemize}
 \item OPORTUNIDADES
    \begin{itemize}
    \item Avance Tecnol\'ogico-
    \end{itemize}
 \item DEBILIDADES
    \begin{itemize}
     \item Contar con un sistema informático rígido que sufre continuos problemas que impiden la actualización de la información.
     \item Falta de capacitación para el manejo de nuevas maquinarias.
     \item El personal se resiste a los cambios tecnológicos.
    \end{itemize}
 \item AMENAZAS
    \begin{itemize}
     \item Entrada de nuevos competidores.
    \end{itemize}
\end{itemize}

\underline{Medidas que se deben poner en práctica:}\\

- Capacitar al personal para el uso de las nuevas maquinarias.\\
- Actualizar el sistema informático para que se actualicen correctamente la información sobre ventas, stock y pedidos de los clientes.\\ \\
