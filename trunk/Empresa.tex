...
\begin{enumerate}
  ...
  - Desarrolle organigrama.
     \begin{center}
      \includegraphics[angle=90, scale=0.60]{./orgEmporioAutomotor.png}
     \end{center}
\newpage  
...
\begin{center}
      \includegraphics[scale=0.34]{./Diagrama2Emporio.png}
     \end{center}
...
\subsubsection*{\textbf{Organigrama derivado de la reuni\'on}}
\begin{center}
\includegraphics[angle=90,scale=0.45]{./IcomOrganigramaNuestro4.png}
\end{center}
