...
% Comando \puesto. Uso: \puesto{Nombre del puesto}{Dirección}{Responde a}{Descripción del puesto}{Funciones}{Responsabilidad}{Autoridad}{Perfil del puesto}
\newcommand{\puesto}[8]{
...
\puesto{Sector de Ventas Locales}{Gerencia de Comercializaci\'on}{Direcci\'on General}
{
...
\puesto{Sector de Comercio Exterior}{Gerencia de Comercializaci\'on}{Direcci\'on General}
{ 
...
{
Comprende todo lo relacionado con la investigaci\'on b\'asica y aplicada y el desarrollo para el mejoramiento de productos, procesos nuevos e investigaci\'on para el mejoramiento de procesos y desarrollo.
}
{
\begin{itemize}
