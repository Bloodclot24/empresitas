...
\end{description}
\underline{\textit{Direcci\'on:}}  Direcci\'on \\
\underline{\textit{Reporta a:}} \textit{Nadie} \\
\underline{\textit{Descripci\'on del puesto:}} Gerente General
\bigskip
\bigskip
\\
...
\begin{tabular}{|l|l|}
\hline
\multirow{6}{0.5cm}{\vspace{24mm} \textbf{\\G\\E\\R\\E\\N\\C\\I\\A}\\ 
\vspace{5mm} 
\textbf{G\\E\\N\\E\\R\\A\\L}}
&\\ &\textbf{\underline{Funci\'on:}}\\ &\\

&-Liderar el planeamiento estrat\'egico de la empresa\\ &\\
&-Desarrollar estrategias generales para alcanzar estos objetivos propuestos\\ &\\ 
&-Distribuir estos objetivos entre las diferentes \'areas\\ &\\
&-Seleccionar personal competente para liderar los diferentes departamentos\\ &\\
&-Aprobar, modificar o rechazar todo tipo de sugerencias\\ &\\

\cline{2-2}
&\\ &\textbf{\underline{Responsabilidad:}}\\ &\\
&-Planear, dirigir y controlar las actividades de la empresa\\ &\\
&-Fijar los objetivos generales (globales) de la empresa\\ &\\
&-Asignar objetivos y recursos a cada sector y departamento\\ &\\
&-Velar por el buen funcionamiento de la empresa\\ &\\

\cline{2-2}
&\\ &\textbf{\underline{Autoridad:}}\\ &\\
&-Autoridad absoluta sobre todo el personal de la empresa\\ &\\
&-Puede delegar y cambiar autoridades, funciones y esponsabilidades a los gerentes de los\\
...
\smallskip
Del relevamiento de este sector surgen diferencias respecto del organigrama presentado por la empresa, ya que si bien se ocupa de las impresiones y dise\~nos de la misma, tambien realiza trabajos para otras empresas, por lo que puede decir que no cumple funciones de Linea sino de Staff.

    \begin{description}
     \item[Dise\~no Gr\'afico] 
     \end{description}
      \underline{\textit{Direcci\'on:}}  Dise\~no Gr\'afico \\
      \underline{\textit{Reporta a:}} Gerente general \\
      \underline{\textit{Descripci\'on del puesto:}} Dise\~nador Gr\'afico \\
      \underline{\textit{Funci\'on:}}
        \begin{itemize}
      ...
      \underline{\textit{Responsabilidad:}} \\
      \underline{\textit{Autoridad:}} \\
      \underline{\textit{Perfil del puesto:}} \\
      \begin{itemize}
...
\subsubsection{Gerencia de Administraci\'on de Personal y Finanzas}
 ...
 \bigskip
     ...
     \item[Administraci\'on contable] 
     \end{description}
      \underline{\textit{Direcci\'on:}}  Administraci\'on del personal y finanzas \\
      \underline{\textit{Reporta a:}} Gerente general \\
      \underline{\textit{Descripci\'on del puesto:}} Encargado de contabilidad y finanzas
      \bigskip
      \bigskip
      \\
      \underline{\textit{Funci\'on:}} \\
     ...
     \end{description}
      \underline{\textit{Direcci\'on:}}  Administraci\'on del personal y finanzas \\
      \underline{\textit{Reporta a:}} Gerente general \\
      \underline{\textit{Descripci\'on del puesto:}} Administraci\'on del personal y legales 
      \bigskip
      \bigskip
      \\
      \underline{\textit{Funci\'on:}} 
...
\begin{description}
 \item Sector de Ventas Locales
    ...
    \item[-] \underline{Reporta a}: Direcci\'on General
    \item[-] \underline{Descripci\'on del Puesto}:
  Se encarga de administrar las ventas en el \'ambito nacional. Se identifican dos tipos de clientes: los mayoristas y los minoristas.
  A los primeros se les da una especie de trato especial, que en los \'ultimos tiempos ha fortalecido la comunicaci\'on con ellos ya 
  que son los clientes prioritarios de Nike Argentina SRL. Por otro lado, los minoristas no reciben cat\'alogos ni se les 
  notifican los aumentos de precios. No se los contacta para evaluar las condiciones del mobiliario o sugerir su reposici\'on.
    \item[-] \underline{Funci\'on}:
	      \begin{itemize}
	      \item Recibir y Coordinar Pagos
	      \item Contactar clientes locales e informar modificaciones del cat\'alogo
	      \item Coordinar plazos de entrega
	      \end{itemize}
    \item[-] \underline{Responsabilidad}:
	      \begin{itemize}
	       \item Priorizar a los clientes mayoristas
	       \item Asegurar el cumplimiento de plazos de entrega convenidos
	      \end{itemize}
    \item[-] \underline{Autoridad}:
		\begin{itemize}
		 \item Informar a producci\'on sobre los requerimientos
 ...
 \item Sector de Comercio Exterior
    ...
    \item[-] \underline{Descripci\'on del Puesto}:
  La situaci\'on es similar al sector de ventas locales, con la diferencia que hay clientes m\'as prioritarios.
  El contacto con ellos es frecuente y semestralmente, como con el resto de los clientes mayoristas de exportación, 
  se realiza una planificación de pedidos que involucra aperturas de locales y remodelación de los existentes.
  Sin embargo, la comunicaci\'on carece de formalidad y trae como consecuencia muchas confusiones ya que los clientes 
  suelen contactar directamente al presidente de la empresa. El hecho de que el cliente en ocasiones se contacte de forma 
  directa con el presidente quita autoridad a lo coordinado previamente con el sector de comercio exterior.
    \item[-] \underline{Funci\'on}:
	      \begin{itemize}
...
\smallskip
Este sector se encarga de prestar los medios materiales necesarios para desarrollar las metas que se propone la empresa. Su acci\'on conjunta con Planeamiento es de gran importancia en t\'erminos de innovaci\'on para los productos y respuestas inmediatas a las exigencias del mercado en general y de su principal cliente, Nike.

\begin{description}
     \item[Ingenier\'ia y Desarrollo] 
\end{description} 
\smallskip
\underline{\textit{Direcci\'on:}} Gerencia de Ingenier\'ia y Desarrollo\\
\underline{\textit{Reporta a:}} Gerente General \\
\underline{\textit{Descripci\'on del puesto:}} Comprende todo lo relacionado con la investigaci\'on b\'asica y aplicada y el desarrollo para el mejoramiento de productos, procesos nuevos e investigaci\'on para el mejoramiento de procesos y desarrollo.
\bigskip
\bigskip
\\
...
\underline{\textit{Funci\'on:}} \\
\begin{itemize}
	\item[-] Su principal inter\'es se centra en la optimizaci\'on de los recursos para su mejor aprovechamiento. Si bien los procesos de industrializaci\'on en la empresa han sido siempre paulatinos, esta \'area tiene la funci\'on de suministrar los recursos t\'ecnicos y formales necesarios para que el empleado pueda desarrollarse adecuadamente en el \'ambito laboral en el que est\'a inserto, atendiendo a sus necesidades de modo de lograr un equilibrio entre las satisfacci\'on laboral de su personal y las exigencias del mercado.
	
\end{itemize}

\underline{\textit{Responsabilidad:}} \\
\begin{itemize}
   \item[-] Implementar sistemas de producci\'on m\'as eficientes y funcionales al sistema que respeten los valores intr\'insecos de la empresa. En ese sentido, no s\'olo tiene la responsabilidad de llevar al cabo los distintos planes productivos que muchas veces traen aparejados mejoras tecnol\'ogicas sino tambi\'en mejorar las condiciones de producci\'on para alcanzar as\'i una mayor efectividad. 
