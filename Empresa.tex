...
\begin {center}
	\includegraphics[width=400pt]{./IcomOrganigramaNuestro2.png}
\end{center}
...
\begin{tabular}{|c|c|c|}
	...
	\multicolumn{3}{|p{0.86\linewidth}|}{Por parte de UBA: Garbiso, Julian; Stephanie, Zurita; Ygounet, Guido } \\
	\hline
    \rowcolor[gray]{0.8} & & \\
    \hline
    \textbf{Tema} & \textbf{Solución} & \textbf{Responsable}\\
...
\begin{center}
	\includegraphics[scale=0.55,angle=90,keepaspectratio=true]{./IcomOrganigramaNuestro3.png}
\end{center}
